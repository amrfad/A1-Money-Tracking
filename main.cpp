...
int main() {
    ...
    aUser1.transaksi_masuk[1] = {tanggal5, 0, 1000000};
    aUser1.transaksi_masuk[2] = {tanggal6, 0, 900000};
    aUser1.transaksi_masuk[3] = {tanggal1, 1, 500000};
    aUser1.transaksi_masuk[4] = {tanggal2, 0, 450000};
